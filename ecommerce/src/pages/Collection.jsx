...
const Collection = () => {
  ...
  const toggleCategory = (e) =>{
    // if it is selected previously then we will unsselect this and also remove from category state
    if(category.includes(e.target.value)){
      setCategory(prev => prev.filter(item=>item !== e.target.value))
    }
    // either we will add this into category state
    else{
